...
public class StudentServiceImpl implements StudentService {
    ...
    @Override
    public Page<StudentResponse> getStudentsByUserAndNameAndLastNameAndDni(User user, String filters, StudentSituation status, Boolean isActive, Pageable pageable) {
        Page<StudentResponse> studentsPage = studentRepository
                .getStudentsByUserAndFilters(user, filters, isActive, pageable)
